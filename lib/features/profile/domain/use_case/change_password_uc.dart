...
class ChangePasswordUseCase extends BaseUseCase<Map<String, dynamic>, ChangePasswordModel> {
  BaseRepositoryProfile baseRepository;

  ChangePasswordUseCase({required this.baseRepository});

  @override
  Future<Either<Map<String, dynamic>, Failure>> call(ChangePasswordModel parameter) async {
